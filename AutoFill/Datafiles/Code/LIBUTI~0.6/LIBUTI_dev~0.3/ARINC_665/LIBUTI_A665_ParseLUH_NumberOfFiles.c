...
)
{
    ...
    v_DataFileListOffset = p_LUH_ConstantSizeFirstFields->s_PointerToDataFilesList * 2ul;
    ...
    *p_NumberOfDataFiles = (uint32_t)(*(uint16_t*)*p_DataFilesList); /* %RELAX<SYNCHRONe_C_Code_10.7,SYNCHRONe_C_Code_11.1> Reading value in memory */
    ...
    v_SupportFileListOffset = p_LUH_ConstantSizeFirstFields->s_PointerToSupportFilesList * 2ul;
