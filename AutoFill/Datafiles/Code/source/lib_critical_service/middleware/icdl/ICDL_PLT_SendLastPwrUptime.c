...
#define K_LASTPWRUPTIME_CMD_UDP_PORTS_SRC  49100
#define K_LASTPWRUPTIME_CMD_UDP_PORTS_DST  49100


/* ---------- provided operation bodies: ------------------------------------ */
void ICDL_PLT_SendLastPwrUptime ( CMN_SYSTEM_ADDR_t const p_buff_addr,
...

{
    ...
    */
   eventBlock_cmd = ICDL_LG_TriggerCommand( ID_CMD_LASTPWRUPTIME, (uint16_t)p_buff_size );

   /*
    * Set channel transmission
    */
   eventBlock_cmd->st_descriptor->ethUdpInfo.s_SrcPort = K_LASTPWRUPTIME_CMD_UDP_PORTS_SRC;
   eventBlock_cmd->st_descriptor->ethUdpInfo.s_DstPort = K_LASTPWRUPTIME_CMD_UDP_PORTS_DST;
