...
/****************************************************************************************/
#include "LIBBSP_SPI_Write2Bytes.h"
/*==== Definitions =====================================================================*/
                            ...
                            TE_LIBBSP_SPI_ErrorCode * const v_SpiErr)
{
   ...
   *v_SpiErr = E_LIBBSP_SPI_OK;
   ...
   /*}}RELAX<SYNCHRONe_C_Code_17.4> */
   /* Configure the SPI bus to send 2 chars on Chip select 1 */
   switch (SpiDevice)
   {
      case E_LIBBSP_SPI_FLASH_PROGRAM:
         V_SPI_Regs->spcom.R = (uint32_t)C_SPI_BUS_FLASH_PROGRAM_2CHAR;
         break;
      case E_LIBBSP_SPI_MRAM:
         V_SPI_Regs->spcom.R = (uint32_t)C_SPI_BUS_MRAM_2CHAR;
         break;
      case E_LIBBSP_SPI_FLASH_BITE:
         V_SPI_Regs->spcom.R = (uint32_t)C_SPI_BUS_FLASH_BITE_2CHAR;
         break;
      default:
         V_SPI_Regs->spcom.R = (uint32_t)C_SPI_BUS_DEFAULT_2CHAR;
         break;
   }
