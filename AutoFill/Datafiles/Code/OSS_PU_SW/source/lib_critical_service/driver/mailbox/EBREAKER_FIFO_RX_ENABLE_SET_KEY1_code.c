 ...
 * --------------------------------------------------------------------------
 * DESCRIPTION : Mailbox Rx enable Key1 function
 * -------------------------------------------------------------------------- */
...
/* ---------- internal constants: ------------------------------------------- */
#define F_FIFO_RX_ENABLE_SET_KEY1 (reg32_t)0x806F7440

/* ---------- internal data: ------------------------------------------------ */

/* ---------- provided operation bodies: ------------------------------------ */
/* */
void EBREAKER_FIFO_RX_ENABLE_SET_KEY1 ( CMN_IOSP_ID_t const p_MBX_FIFO_conf_id )
{
   /* Local Variable Declaration */
   ts_MBX_RX_REG volatile * pt_rx_enable_set_key_1_reg;
   ...
   pt_rx_enable_set_key_1_reg = (ts_MBX_RX_REG volatile *)c_MBX_CFEX_CONFIGURATION_tab[p_MBX_FIFO_conf_id].s_mbx_rx_fifo_address;

   /* Return Status value */
   /* >RELAX<SYNCHRONe_C_Code_10.7> The cast changes register type to data type with same size */
   pt_rx_enable_set_key_1_reg->s_RX_ENABLE_SET_KEY_1_REG = F_FIFO_RX_ENABLE_SET_KEY1;
