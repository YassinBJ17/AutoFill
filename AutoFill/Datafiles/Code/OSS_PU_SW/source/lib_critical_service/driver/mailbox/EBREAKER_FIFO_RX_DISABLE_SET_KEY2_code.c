 ...
 * --------------------------------------------------------------------------
 * DESCRIPTION : Mailbox Rx disable Key2 function
 * -------------------------------------------------------------------------- */
...
/* ---------- internal constants: ------------------------------------------- */
#define F_FIFO_RX_DISABLE_SET_KEY2 (reg32_t)0x46C7C8EA

/* ---------- internal data: ------------------------------------------------ */

/* ---------- provided operation bodies: ------------------------------------ */
/* */
void EBREAKER_FIFO_RX_DISABLE_SET_KEY2 ( CMN_IOSP_ID_t const p_MBX_FIFO_conf_id )
{
   /* Local Variable Declaration */
   ts_MBX_RX_REG volatile * pt_rx_disable_set_key_2_reg;
   ...
   pt_rx_disable_set_key_2_reg = (ts_MBX_RX_REG volatile *)c_MBX_CFEX_CONFIGURATION_tab[p_MBX_FIFO_conf_id].s_mbx_rx_fifo_address;

   /* Return Status value */
   /* >RELAX<SYNCHRONe_C_Code_10.7> The cast changes register type to data type with same size */
   pt_rx_disable_set_key_2_reg->s_RX_ENABLE_CLEAR_KEY_2_REG = F_FIFO_RX_DISABLE_SET_KEY2;
