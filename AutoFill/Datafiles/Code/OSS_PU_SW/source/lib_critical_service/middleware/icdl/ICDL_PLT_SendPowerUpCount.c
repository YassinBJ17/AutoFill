...
#define K_POWERUPCOUNT_CMD_UDP_PORTS_SRC  49900
#define K_POWERUPCOUNT_CMD_UDP_PORTS_DST  49900


/* ---------- provided operation bodies: ------------------------------------ */
void ICDL_PLT_SendPowerUpCount ( CMN_SYSTEM_ADDR_t const p_buff_addr,
...

{
    ...
    */
   eventBlock_cmd = ICDL_LG_TriggerCommand( ID_CMD_POWERUPCOUNT, (uint16_t)p_buff_size );

   /*
    * Set channel transmission
    */
   eventBlock_cmd->st_descriptor->ethUdpInfo.s_SrcPort = K_POWERUPCOUNT_CMD_UDP_PORTS_SRC;
   eventBlock_cmd->st_descriptor->ethUdpInfo.s_DstPort = K_POWERUPCOUNT_CMD_UDP_PORTS_DST;
