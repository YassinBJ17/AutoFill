...
#define K_DATA_LOG_CMD_UDP_PORTS_SRC  49500
#define K_DATA_LOG_CMD_UDP_PORTS_DST  49500


/* ---------- provided operation bodies: ------------------------------------ */
void ICDL_PLT_SendDataLog ( CMN_SYSTEM_ADDR_t const p_buff_addr,
...

{
   ...
   CMN_IOSP_ID_t v_logType = (CMN_IOSP_ID_t)p_logType;

   /*
    * Check the command can be handled
    */
   eventBlock_cmd = ICDL_LG_TriggerCommand( ID_CMD_DATA_LOG, (uint16_t)p_buff_size );

   /*
    * Set channel transmission
    */
   eventBlock_cmd->st_descriptor->ethUdpInfo.s_SrcPort = K_DATA_LOG_CMD_UDP_PORTS_SRC ;
   eventBlock_cmd->st_descriptor->ethUdpInfo.s_DstPort = K_DATA_LOG_CMD_UDP_PORTS_DST ;
   ...
   {
      ICDL_LG_ComputeMsgArgSet( (int8_t *)&v_logType, sizeof (CMN_IOSP_ID_t), eventBlock_cmd );
