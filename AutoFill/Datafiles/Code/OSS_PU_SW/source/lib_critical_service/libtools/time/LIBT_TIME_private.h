...
#ifndef LIBT_TIME_PRIVATE_H
#define LIBT_TIME_PRIVATE_H
...
/* {{RELAX<SYNCHRONe_C_Code_8.17,SYNCHRONe_C_Code_5.4,SYNCHRONe_C_Code_6.6> : Register definition : all fields are defined even if there are not used. The format is compliant with register definition */
typedef union
{
   reg32_t u_reg32;
   struct
