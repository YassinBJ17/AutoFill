 ...
 * --------------------------------------------------------------------------
 * DESCRIPTION : CSS wrapper G1_2_3 slow task function definition
 * -------------------------------------------------------------------------- */
...
void css_wrapper_g1_2_3_slow_task(void)
{
   if(CANCEL_AS_CALLS_KEY != cancel_as_calls_key)
   {
      /* Calling CSS wrapper G1_2_3 slow task function stored in the flash address */
      (CSS_WRAPPER_G1_2_3_SLOW_TASK_ADDR)();
   }
   return;
}
