...
#ifndef DMA_CFEX_PUBLIC_H
#define DMA_CFEX_PUBLIC_H

/* ---------- include required interface: ----------------------------------- */
#include "type/common_type.h"
#include "driver/dma/DMA_REG_common.h"
...
extern const te_DMA_CFEX_PRIORITY FDX_c_DMA_CFEX_PRIORITY_tab[ DMA_MAX_NB * DMA_LINE_MAX_NB];
...
extern const uint32_t FDX_c_DMA_CFEX_tab_SIZE;
extern const ts_DMA_CFEX_ELT FDX_c_DMA_CFEX_tab[];

/* ---------- provided data: ------------------------------------------------ */
/* */
/* DMA descriptor */
extern ts_DMA_DESCR FDX_DMA_descr[];
/* }}<SYNCHRONe_C_Code_8.12, SYNCHRONe_C_Code_8.16> */

/* ---------- provided operations: ------------------------------------------ */

#endif /* DMA_CFEX_PUBLIC_H */
