...
void pbit_pld_a429_2ab_rx(void)
{
   ...
   if(fpga_a429_2ab_rx->cmd.u_bit.s_storage_mode != (uint32_t)1)
   {
      /* Log fatal fault */
   ...
   if(fpga_a429_2ab_rx->cmd.u_bit.s_enable_rx != (uint32_t)1)
   {
      /* Log fatal fault */
      logbook_pbit_fatal(0, 0);
   ...
   {
      if(fpga_a429_2ab_rx->gap.u_bit.s_filter_time != LS_FILTER_TIME)
      {
         /* Log fatal fault */
         logbook_pbit_fatal(0, 0);
      ...
      if(fpga_a429_2ab_rx->gap.u_bit.s_gap_bit_time != LS_GAP_BIT_TIME)
      {
         /* Log fatal fault */
         logbook_pbit_fatal(0, 0);
      ...
      if(fpga_a429_2ab_rx->hbit.u_bit.s_max_hbit_time != LS_HBIT_TIME_MAX)
      {
         /* Log fatal fault */
         logbook_pbit_fatal(0, 0);
      ...
      if(fpga_a429_2ab_rx->hbit.u_bit.s_min_hbit_time != LS_HBIT_TIME_MIN)
      {
         /* Log fatal fault */
         logbook_pbit_fatal(0, 0);
      ...
      if(fpga_a429_2ab_rx->bit.u_bit.s_max_bit_time != LS_BIT_TIME_MAX)
      {
         /* Log fatal fault */
         logbook_pbit_fatal(0, 0);
      ...
      if(fpga_a429_2ab_rx->bit.u_bit.s_min_bit_time  != LS_BIT_TIME_MIN)
      {
         /* Log fatal fault */
         logbook_pbit_fatal(0, 0);
