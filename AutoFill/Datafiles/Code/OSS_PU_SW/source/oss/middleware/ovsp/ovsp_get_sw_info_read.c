 ...
 * --------------------------------------------------------------------------
 * DESCRIPTION :  Read Rx SW_INFO response frame
 * -------------------------------------------------------------------------- */
...
void ovsp_get_sw_info_read(uint32_t const ovspx_reg_addr, uint32_t const src_ovspx_ram_addr)
{
   ...
   /* Decode the OVSP Rx response frame to SW_INFO response frame format */
   ovsp_get_sw_info_decode(total_nb_frame_received);
