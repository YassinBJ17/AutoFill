...
#define C_LP_NORMALY_CLOSE ((uint16_t)0x0003)
...
uint16_t lpdisc_process_raw(uint8_t p_task, ts_lpdisk_item * p_item)
{
   uint16_t s_OutValue;
   ...
   {
   case C_RAW_CLOSE:
      if ((p_item->s_io_mask & C_LP_NORMALY_CLOSE) != (uint16_t)0)
