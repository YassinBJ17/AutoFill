 ...
 * --------------------------------------------------------------------------
 * DESCRIPTION : This function computes the CRC-16 of the given memory zone.
 * -------------------------------------------------------------------------- */
...
const uint16_t c_CHKSUM_CRC_16_CODE_tab[ 256ul ]=
{
...
void BOOT_LIBCHK_CRC16_COMPUTE( uint16_t         const p_crc_start,
