 ...
 * --------------------------------------------------------------------------
 * DESCRIPTION : GPIO Read in port function
 * -------------------------------------------------------------------------- */
...
/* */
void BOOT_GPIO_READ_IN_PORT ( CMN_IOSP_ID_t              const p_gpio_conf_id,
                                GPIO_PORT_VALUE_t * const p_logic_value)
{
   ...
   /* Get Current Port Data value */
   *p_logic_value = pt_gpio_ctrl->s_GPIO_IN_PORT[GPIO_CFEX_descriptor_tab[p_gpio_conf_id].s_gpio_id];
