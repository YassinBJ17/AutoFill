 ...
 * --------------------------------------------------------------------------
 * DESCRIPTION : This file contains the DrvGPIO registers configuration
 *               check function
 * -------------------------------------------------------------------------- */
...
/* DrvGPIO_Check_RegConfig : To test the DrvGPIO registers configuration
 *   Inputs: None
 *   Outputs:
 ...
 *   Pre-condition: None
*/
void DrvGPIO_Check_RegConfig (uint32_t * const p_pt_Check_Result)
{
   ...
   *p_pt_Check_Result = OVSP_SW_RESULT_OK;
   ...
   {
      if ((C_DrvGPIO_Registers [v_Iter_Port]->S_PDDR !=
           C_DrvGPIO_Port_Config [v_GPIO_Side_Id] [v_Iter_Port].S_PDDR_Config) ||
           (C_DrvGPIO_Registers [v_Iter_Port]->S_PIDR !=
           C_DrvGPIO_Port_Config [v_GPIO_Side_Id] [v_Iter_Port].S_PIDR_Config))
      {
