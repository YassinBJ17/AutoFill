 ...
 * --------------------------------------------------------------------------
 * DESCRIPTION : This file contains the NGOS2 frequency input acquisition functions
 * -------------------------------------------------------------------------- */
...
/* DrvFTM_Start_NGOS2_Acquisition : To start the NGOS2 frequency acquisition
 *   Inputs: None
 *   Outputs: None
 *   Function return: None
 *   Pre-condition: None
*/
void DrvFTM_Start_NGOS2_Acquisition (void)
{
       ...
       DRVFTM_CNSC_ELSA_SHIFT))
   {
      ...
      switch (v_OVSP_Side_Id)
      {
         ...
         {
            pt_FLEXTIMER3->S_CONTROLS [DRVFTM_CHAN_0].S_CnSC |=
...
/* DrvFTM_Stop_NGOS2_Acquisition : To stop the NGOS2 frequency acquisition
 *   Inputs: None
 *   Outputs: None
 *   Function return: None
 *   Pre-condition: None
