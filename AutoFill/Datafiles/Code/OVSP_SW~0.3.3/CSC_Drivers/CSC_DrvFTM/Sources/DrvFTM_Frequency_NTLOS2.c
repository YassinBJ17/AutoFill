 ...
 * --------------------------------------------------------------------------
 * DESCRIPTION : This file contains the NTLOS2 frequency input acquisition functions
 * -------------------------------------------------------------------------- */
...
/* DrvFTM_Start_NTLOS2_Acquisition : To start the NTLOS2 frequency acquisition
 *   Inputs: None
 *   Outputs: None
...
/* DrvFTM_Stop_NTLOS2_Acquisition : To stop the NTLOS2 frequency acquisition
 *   Inputs: None
 *   Outputs: None
 *   Function return: None
 *   Pre-condition: None
