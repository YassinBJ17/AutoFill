...
/* DrvFTM_Start_NGOS1_Acquisition : To start the NGOS1 frequency acquisition
 *   Inputs: None
 *   Outputs: None
 *   Function return: None
 *   Pre-condition: None
*/
void DrvFTM_Start_NGOS1_Acquisition (void)
{
       ...
       DRVFTM_CNSC_ELSA_SHIFT))
   {
      ...
      switch (v_OVSP_Side_Id)
      {
         ...
         {
            pt_FLEXTIMER0->S_CONTROLS [DRVFTM_CHAN_4].S_CnSC |=
...
/* DrvFTM_Stop_NGOS1_Acquisition : To stop the NGOS1 frequency acquisition
 *   Inputs: None
 *   Outputs: None
 *   Function return: None
 *   Pre-condition: None
