 ...
 * --------------------------------------------------------------------------
 * DESCRIPTION : This file contains the 16-bit CRC computation function
 * -------------------------------------------------------------------------- */
...
#define CONFIG_16BITCRC_TABLE_SIZE   256UL
...
/* ---------- internal constants: ------------------------------------------- */
const uint16_t c_Config_16BitCRC_Table [CONFIG_16BITCRC_TABLE_SIZE] =
{
...
/* Config_Compute_16BitCRC : To compute the ARINC 665 16-bit CRC of a memory area
 *   Inputs:
 *     - p_pt_StartAddr: Area start address
 *     - p_Length: Length of the area
 *   Outputs:
 *     - p_pt_CrcComputed: Computed 16-bit CRC
 *   Function return: None
 *   Pre-condition: None
*/
/* {{RELAX<SYNCHRONe_C_Code_23.2> It is clearer to align Qualifiers, Types and Names. */
void Config_Compute_16BitCRC (const uint8_t  * const p_pt_StartAddr,
                              const uint32_t         p_Length,
                                    uint16_t * const p_pt_CrcComputed)
{
   /* }} RELAX<SYNCHRONe_C_Code_23.2> */
   uint32_t v_Iter_Area;
   uint16_t v_16BitCRC_Result;
   uint8_t  v_Table_Index;

   v_16BitCRC_Result = *p_pt_CrcComputed;
   ...
   *p_pt_CrcComputed = v_16BitCRC_Result;
}
