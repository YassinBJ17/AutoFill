 ...
 * --------------------------------------------------------------------------
 * DESCRIPTION : This file contains the REARM_CMD Command frame decoding function
 * -------------------------------------------------------------------------- */
...
/* CAN_Decode_REARM_CMD_Frame : To decode the REARM_CMD Command frame
 *   Inputs:
 ...
 *   Pre-condition: None
*/
void CAN_Decode_REARM_CMD_Frame (const TS_DrvCAN_RxFrame * const p_pt_RxFrame)
{
   ...
   {
      if (CAN_REARM_OS_KEY_ON == p_pt_RxFrame->S_RxData [OVSP_SW_LONG_0])
      {
         V_CAN_REARM_Rqst = E_OVSP_SW_Requested;
         V_CAN_REARM_Timing = 0UL;
      }
      else
