...
public class SheetsName {
    ...
    public static void Sheets_Name( Workbook workbook){
        ...
        if (ExcelFinal.lowLevelReq[1].length()>MAXIMAL_SHEETNAME_LENGTH)
         {
                String sheet_name= ExcelFinal.lowLevelReq[1].substring(ExcelFinal.lowLevelReq[1].lastIndexOf('_')+1);
                ...
                ExcelModifier.Fill_Cell(B1_Sheet_name,Excel.SHEET_A0,Excel.CELL_ROW_15,Excel.CELL_COL_3);
                  ...
                  String B0_Sheet_name="B0-"+ ExcelFinal.lowLevelReq[1]+"_UFT";
                  String B1_Sheet_name="B1-"+ ExcelFinal.lowLevelReq[1]+"_UTC";
